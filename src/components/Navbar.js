...
export default function Navbar() {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand fst-italic fs-3" to="/">GoFood</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav me-auto mb-1">
        ...
        <li>
       <Link className="nav-link active  " aria-current="page" to="/myfoodorder" >My Orders
        ...
        <div className="d-flex ">
                  ...
                  <span className="badge rounded-pill bg-danger">{data.length}</span></div>
